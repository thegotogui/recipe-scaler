...
<g id="Dial">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding:8px; display: flex; align-items: center; background-color: #2C3E50 !important;">
        ...
        ${iconInsert}         
            <span id="pageTitle" class="pageTitle" style="font-family: 'Helvetica', sans-serif; font-size: clamp(1.4rem, 3.5vw, 2.8rem); color: #F8F9FA;">Pasta/Protein Calculator</span>
        </a>
