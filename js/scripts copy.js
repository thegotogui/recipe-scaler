...
function initializeIt(pageTitle, imageSource) {
  var iconInsert = `<img src="./sc/greyholder.svg" width="50" height="50" class="d-inline-block align-top" alt="" id="pageIcon">`
  ...
  if (pageTitle == "TapTimer") {
    iconInsert = `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 384 384" style="height:50px; width:auto; enable-background:new 0 0 50 50;" xml:space="preserve">
<style type="text/css">
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 384 384" style="height: 50; width; auto; enable-background:new 0 0 384 384;" xml:space="preserve">
<style type="text/css">
	.st0{fill:#B1EAF1;}
	.st1{fill:#26C6DA;}
	.st2{fill:#4ECFE1;}
...
<g id="Dial">
  ...
  document.getElementById("navHead").innerHTML = `
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding:8px;">
        ...
        <div class="jumpButtons">
            <div class="icons" onclick="linkJump(1)"><img class="icon" src="./sc/piechart.svg" width="30px;"
            ...
            <div class="iconsClock" style="width: 30px; height: auto" onclick="linkJump(4)">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<circle class="centerCircle" cx="192" cy="192" r="20"/>
            ...
            <div class="icons" onclick="linkJump(5)"><img class="icon" src="./app_icons/NaCl.svg" width="30px;"
                    style="cursor: pointer;"></div>
            <div class="icons" onclick="linkJump(6)"><img class="icon" src="./assets/img/measurator2.svg" width="30px;"
                    style="cursor: pointer;"></div>
            <div class="icons" onclick="linkJump(7)"><img class="icon" src="./app_icons/conversions.svg" width="30px;"
                    style="cursor: pointer;"></div>
            <div class="icons" onclick="linkJump(8)"><img class="icon" src="./app_icons/butter.svg" width="30px;" style="cursor: pointer;">
            </div>
            <div class="icons" onclick="linkJump(9)"><img class="icon" src="./app_icons/flavor4.svg" width="30px;" style="cursor: pointer;">
            </div>
        </div>
...
function linkJump(which) {
  ...
  switch (which) {
    ...
    case 3:
      window.location.href = "./tinicalc.html";
      break;

    case 4:
      window.location.href = "./taptimer.html";
      break;

    case 5:
      window.location.href = "./saltratio.html";
      break;

    case 6:
      window.location.href = "./measurator.html";
      break;

    case 7:
      window.location.href = "./newconversions.html";
      break;
...
setInterval(() => {
  ...
  // Hours
  var rotationValues = `rotate(${(hours * 30) + (minutes / 2)}, 192, 192)`
  if (document.getElementById("hHourHand")) {
    document.getElementById("hHourHand").setAttribute("transform", rotationValues);
  }
  if (document.getElementById("pHourHand")) {
    document.getElementById("pHourHand").setAttribute("transform", rotationValues);
  }

  // Minutes
  rotationValues = `rotate(${(minutes * 6) + (seconds / 10)}, 192, 192)`
  document.getElementById("hMinuteHand").setAttribute("transform", rotationValues);

  if (document.getElementById("pMinuteHand")) {
    document.getElementById("pMinuteHand").setAttribute("transform", rotationValues);
  }

  // Seconds
  rotationValues = `rotate(${(seconds * 6)}, 192, 192)`
  document.getElementById("hSecondHand").setAttribute("transform", rotationValues);
  if (document.getElementById("pSecondHand")) {
    document.getElementById("pSecondHand").setAttribute("transform", rotationValues);
  }
  ...
  link.rel = 'icon';
  link.type = 'image / png';
  // link.href = `./miniclock/miniclock_${paddingH}${hours}${paddingM}${minutes}.png`;
  link.href = `./miniclock/miniclock_test.png`;
  if (oldLink) {
